 ...
 *         &lt;element name="idPosition" type="{http://www.w3.org/2001/XMLSchema}double"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "Jalousie_1_moveToPos")
public class Jalousie1MoveToPos {

    @XmlElement(name = "BlockGuid", required = true)
    protected String blockGuid;
    protected double idPosition;
     ...
     * 
     */
    public void setIdPosition(double value) {
